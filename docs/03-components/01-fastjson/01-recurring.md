...
新建项目 src/main/java/org/example/GroovyPoc.java
...
src/main/resources/META-INF/services/org.codehaus.groovy.transform.ASTTransformation 写入恶意类
...
对于 Fastjson 1.2.36-1.2.62 的版本存在dos漏洞 https://b1ue.cn/archives/314.html
