...
[fastjson check](docs/component/fastjson/fastjsonCheck/fastjsonCheck.md)

# 0x02 全版本poc合集

[1.2.24-1.2.80 poc](docs/component/fastjson/recurring.md)

# 0x03 bypass

绕过手段

[bypass](docs/component/fastjson/bypass/bypass.md)
